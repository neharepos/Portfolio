...
<template>
  <div class="flex justify-center sm:px-4 md:px-5">
    <div
      class="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-full transition duration-300 hover:bg-zinc-800 bg-zinc-900 backdrop-blur-md rounded-2xl p-5 cursor-pointer shadow-lg group border-zinc-800 border-2"
    >
